...
$params = array('run'        => array(XHPROF_STRING_PARAM, ''),
                ...
                'sort'       => array(XHPROF_STRING_PARAM, 'excl_wt'), // wall time
...
$xhprof_runs_impl = new XHProfRuns_Default(realpath(__DIR__ . '/../../../../storage/profiler'));

isset($_REQUEST['run']) and $params['run'] = $run = $_REQUEST['run'];
